...
// Get the value at position 1 and mark it consumed.
...
4. If the property is a `bool` and there exists a flag with that name (case-insensitive), it will set the property to `true`.
